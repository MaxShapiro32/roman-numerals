from app.routes.converter import converter_blueprint
...
app.register_blueprint(converter_blueprint, url_prefix="/api/v1/converter")
...
def info():
    ...
    return jsonify(
        {
            "service": os.environ["SERVICE"] if "SERVICE" in os.environ else "converter",
            "hostname": socket.gethostname(),
            "database": None,
            "children": info_list,
            "language": "Python",
            "url": os.environ["Converter_URL"]
            if "Converter_URL" in os.environ
